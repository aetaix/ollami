  ...
  >
    ...
    <div bind:this={chatContainer} class="h-full overflow-y-auto pt-20 pb-32">
      ...
      {:else}
        ...
        >
          <div class="w-full max-w-2xl mx-auto bg-black-100 text-black-400 rounded-lg p-4 flex items-center gap-2 justify-center">
            ...
            Your chat model is not installed. Please <a href="/models" class="underline">install it</a> to resume the
            chat.
          </div>
        </div>
      {/if}
