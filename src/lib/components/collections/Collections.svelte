...
{#if $collections.length === 0}
	...
	>
		<div class="w-full flex-grow flex justify-center items-center">
			<div
				class="bg-white dark:bg-black-700 max-w-md mx-auto shadow-lg rounded-xl border border-black-200 dark:border-black-600"
			>
				...
				<footer
					class="border-t border-black-200 dark:border-black-600 p-4 flex items-center justify-end"
				>
